 ...
 * @brief Header file for Numerical Tic-Tac-Toe game classes.
 * @author Mohamed Ibrahim
 *
 * This file provides:
 * - `NumericaleTicBoard`: A specialized board class for the Tic-Tac-Toe game.
 * - `NumericaleTicUI`: A user interface class tailored to This game setup and player interaction.
 */
