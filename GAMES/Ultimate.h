/**
 * @file Ultimate.h
 * @brief Header file for Ultimate Tic-Tac-Toe game classes.
 * @author Hamza Mohamed
 *
 * This file provides:
 * - `Ultimate_MainBoard`: A specialized board class for the Tic-Tac-Toe game.
 * - `Ultimate_UI`: A user interface class tailored to This game setup and player interaction.
 */
